    ...
    <footer className="footer--container">
      <div className="footer--link--container">
        ...
        <div className="footer--items">
          <ul>
            <li>
              <Link spy={true} smooth={true} offset={-70} duration={500} to="/" className="text-md">
                Home
              </Link>
            </li>
            <li>
      ...
      <hr className="divider" />
        ...
        <p>Copyright 2023 Rising media club . All Rights Reserved.</p>
        <br />
        <br/>
        <br/>
        <br/>
        <br/>
        <br/>
<a href="https://kenanda-rabah.onrender.com" style={{color:"black", textDecoration:"none"}}> Produced by Kenanda Abdelouahad Rabah</a>
      </div>
    </footer>
  );
}
